...
public class TypewriterLabel: UILabel {
    ...
    public var typingTimeInterval: TimeInterval = 0.06
    ...
    private func setAlphaOnAttributedText(alpha: CGFloat) {
        ...
        attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: textColor.withAlphaComponent(alpha), range: NSRange(location:0, length: attributedString.length))
    ...
    private func setAlphaOnAttributedText(alpha: CGFloat, chracterIndex: Int) {
        ...
        attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: textColor.withAlphaComponent(alpha), range: NSRange(location: utf16CharacterLocation, length: count))
        self.attributedText = attributedString
